...
This script creates the data for figure 5, comparing left vs right MFG activity after an attack.
...
It produces `figure5_ghost_attack_lr_mfg_plot.png` in the `figures/attack` folder.
...
lr_mfg_plot <- mfg_hfa_avg_df %>% 
  ...
  scale_color_manual(values = c("darkgrey", "#876194")) +
  scale_fill_manual(values = c("darkgrey", "#876194")) +
  labs(title = "",
       fill = "Hemisphere",
       color = "Hemisphere",
       x = "Time (s)",
...
ggsave(path(here(), "figures", "attack", "figure5_ghost_attack_lr_mfg_plot.png"), 
       plot = lr_mfg_plot, 
