...
# Creates Figure 3 Coherence ~ Region*Time Plots (Figure 3g)

Takes the output of the regional rising/falling models and calculates the significant region pairs

Technically, the script creates old versions of the figures `figure3_rising_roi.png` and `figure3_falling_roi.png`, which I used to manually create the brain versions of the plots

Inputs:
* `2_roi_rising_model_brms.RData` in the `results/rising_falling_coherence` folder
* `2_roi_falling_model_brms.RData` in the `results/rising_falling_coherence` folder
...
# load rising model #
load(path(here(), "results", "rising_falling_coherence", "2_roi_rising_model_brms.RData"))
...
ggsave(path(here(), "figures", "connectivity", "figure3_rising_roi.png"), 
...
# load falling model #
load(path(here(), "results", "rising_falling_coherence", "2_roi_falling_model_brms.RData"))
...
ggsave(path(here(), "figures", "connectivity", "figure3_falling_roi.png"), 
       plot = avoid_roi_plot, 
       width = 3.5, height = 2, units = "in", dpi = 2000)
