...
# Concatenate Power Estimations by Frequency and Region

Compiles all the ieeg data that is calculated using Morlet Wavelets, but does not bind with the behavioral files

Run by knitting

Inputs
* All the output files created in `Staveland_et_al_Pacman_Neural_Analyses/blob/main/preprocessing/scripts/export_iti_baselined_csvs.ipynb`

Outputs
* A CSV with power values for each frequency band, and region
