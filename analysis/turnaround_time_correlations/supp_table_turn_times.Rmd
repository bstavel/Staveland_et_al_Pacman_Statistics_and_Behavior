...
#  Model Results &  Posterior Predictive Checks on Syncrhony ~ Approach Time models (Supplemental Table 6 & 9)

This script loads the model results from the brms models and creates tables summarizing the fixed effects and posterior predictive checks for each model.

Inputs:
* `results/full_all_roi_model_brms_newsubs_noinsula.RData` - Theta model results
* `results/full_hfa_all_roi_model_brms_newsubs.RData` - HFA model results
