...
# Creates Figure 3 Rising/Falling Plots (Figure 3e,f)

Takes the output of the rising/falling models and prepares plots

Inputs:
* `2_rising_model_brms.RData` in the `results/rising_falling_coherence` folder
* `2_falling_model_brms.RData` in the `results/rising_falling_coherence` folder

Outputs:
* `figure3_rising_falling_posterior_distributions.png` in the `figures/connectivity` folder
* `figure3_rising_sub_eff.png` in the `figures/connectivity` folder
* `figure3_falling_sub_eff.png` in the `figures/connectivity` folder
