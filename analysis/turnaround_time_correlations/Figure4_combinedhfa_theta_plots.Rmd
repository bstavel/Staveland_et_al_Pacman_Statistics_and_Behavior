...
## Figures showing correlation between Approach Time and Synchrony

This script takes the model summaries and uses them to create Figure 4 Panels C, D

Inputs:
* `theta_model_results_summary_plot_df.csv` in `results/turn_time_prediction` folder
* `hfa_model_results_summary_plot_df.csv` in `results/turn_time_prediction` folder
* `theta_example_correlation_df.csv` in `results/turn_time_prediction` folder
* `hfa_example_correlation_df.csv` in `results/turn_time_prediction` folder

Outputs:
* `figure4_turn_time_posterior_dist_combined_plot.png` in `results/turn_time_prediction` folder
* `figure4_turn_time_combined_example_plot.png` in `results/turn_time_prediction` folder
