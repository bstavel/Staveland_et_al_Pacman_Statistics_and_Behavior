...
This script uses the power estimates for each electrode and goes trial by trial and calculates the correlation between all electrode pairs across regions for each trial. 
