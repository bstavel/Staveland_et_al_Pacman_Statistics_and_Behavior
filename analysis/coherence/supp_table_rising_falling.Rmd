...
# Create Supplementary Tables For Coherence ~ Time Analyses

Inputs:
* `1.5_rising_model_brms.RData` in the `results/` folder
* `1.6_rising_model_brms.RData` in the `results/` folder
* `1.7_rising_model_brms.RData` in the `results/` folder
* `1.8_rising_model_brms.RData` in the `results/` folder
* `2_rising_model_brms.RData` in the `results/` folder
* `1.5_falling_model_brms.RData` in the `results/` folder
* `1.6_falling_model_brms.RData` in the `results/` folder
* `1.7_falling_model_brms.RData` in the `results/` folder
* `1.8_falling_model_brms.RData` in the `results/` folder
* `2_falling_model_brms.RData` in the `results/` folder
* `2_rising_model_pli_brms.RData` in the `results/` folder
* `2_falling_model_pli_brms.RData` in the `results/` folder
* `2_rising_model_ppc_brms.RData` in the `results/` folder
* `2_falling_model_ppc_brms.RData` in the `results/` folder
