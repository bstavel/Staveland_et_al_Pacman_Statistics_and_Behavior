...
roi_colors <-  c("Amygdala" = "#DE4A4D", "Hippocampus" = "#FFA602", "OFC" =  "#88D1A3", "ACC"=  "#3D99BA",  "MFG" = "#876194")

```


## Create plots showing regional differences in connectivity (Figure 3, Panel C)

Takes the region specifc models and picks out one region pair to showcase in Figure 3
...
Outputs:
* `figure3_differential_theta_coherence_amyg.png` in the `figures/connectivity/` folder
* `figure3_differential_theta_coherence_hc.png` in the `figures/connectivity/` folder
* `figure3_differential_theta_coherence_ofc.png` in the `figures/connectivity/` folder
* `figure3_differential_theta_coherence_acc.png` in the `figures/connectivity/` folder
* `figure3_differential_theta_coherence_mfg_p1.png` in the `figures/connectivity/` folder
* `figure3_differential_theta_coherence_mfg_p2.png` in the `figures/connectivity/` folder
