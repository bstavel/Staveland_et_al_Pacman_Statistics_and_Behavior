...
This script prepares the data and runs region-specific models of theta coherence using the other regions as a predictor in the approach and avoidance periods.
...
* `imcoh_avd_hc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_amyg_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_ofc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_acc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_mfg_second_roi_model.RData` in the `results/` folder
