...
## Theta Coherence ~ Region Models

This script prepares the data and runs region-specific models of theta coherence using the other regions as a predictor in the approach and avoidance periods, but for the two alternate connectivity metrics (Pairwise Phase Consistency and Phase Locking Value)
...
Outputs:
* `imcoh_app_hc_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_app_amyg_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_app_ofc_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_app_acc_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_app_mfg_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_app_hc_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_app_amyg_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_app_ofc_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_app_acc_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_app_mfg_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_hc_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_amyg_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_ofc_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_acc_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_mfg_ppc_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_hc_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_amyg_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_ofc_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_acc_plv_second_roi_model.RData` in the `results/` folder
* `imcoh_avd_mfg_plv_second_roi_model.RData` in the `results/` folder
