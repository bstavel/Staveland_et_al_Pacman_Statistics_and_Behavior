...
Creates an example plot of theta coherence analysis using one electrode pair from one subject. 

Input:
* `SLCH002_example_imcoh_fig3.csv` which comes from the `Staveland_et_al_Pacman_Neural_Analyses/blob/main/connectivity/` repo

Output:
* `figure3_example_elec_pair.png` in the `figures/connectivity` folder
