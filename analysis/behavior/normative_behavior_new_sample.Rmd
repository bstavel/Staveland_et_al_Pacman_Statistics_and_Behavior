...
# game data #
pilot_clinical_game_data <- read_csv(path(here(), '../behavioral_parsing/prolific_data_clean/cleaned_pacman_200_trial_CLINICAL_n59.csv'), 
...
pilot_nonclinical_game_data <- read_csv(path(here(), '../behavioral_parsing/prolific_data_clean/cleaned_pacman_200_trial_NONCLINICAL_n63.csv'), 
                                                                                              col_types = cols(X1 = col_double(),
                                                                                              subject = col_character(),
                                                                                              Trial = col_character(),
                                                                                              Lives = col_double(),
...
# behavioral data#
pilot_clinical_behave_data <- read_csv(path(here(), '../behavioral_parsing/prolific_data_clean/cleaned_behave_data_200_trial_CLINICAL_n59.csv'), 
                                       col_types = cols())
pilot_nonclinical_behave_data <- read_csv(path(here(), '../behavioral_parsing/prolific_data_clean/cleaned_behave_data_200_trial_NONCLINICAL_n63.csv'), 
                              col_types = cols())

## Merge
pilot_game_data <- rbind(pilot_clinical_game_data %>% select(-level_4) %>% mutate(case = "clinical"), 
                         pilot_nonclinical_game_data %>% mutate(case = "nonclinical"))
pilot_behave_data <- rbind(pilot_clinical_behave_data %>% rename(race = Q60, race_TEXT = Q60_7_TEXT) %>% mutate(case = "clinical"), 
                           pilot_nonclinical_behave_data%>% rename(race = Q58, race_TEXT = Q58_6_TEXT) %>% mutate(case = "nonclinical"))
```
...
write_csv(pilot_behave_data, path(here(), "munge", "prolific", "cleaned_pilot_behavior_newsample.csv"))
write_csv(pilot_game_data_clean, path(here(), "munge", "prolific", "cleaned_pilot_game_data_newsample.csv"))
write_csv(pilot_game_data_distance, path(here(), "munge", "prolific", "cleaned_pilot_distance_data_newsample.csv"))
write_csv(pilot_all_vars_df, path(here(), "munge", "prolific", "cleaned_pilot_across_trial_data_newsample.csv"))
