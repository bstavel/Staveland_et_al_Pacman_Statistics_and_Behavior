...
# Create Supplemental Figures based on the differentail connectivity analyses (coherence ~ region)

Specifically, this script create the supplemental figures based on the alternate versions of the connectivity metrics (PPC and PLV)
...
Outputs:
* `figure3_differential_theta_coherence_tug_REGION_METRIC.png` figures in the `figures/connectivity/` folder which are used to create Supplemental Figure 6
